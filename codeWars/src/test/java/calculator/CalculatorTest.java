...
public class CalculatorTest {
    ...
    public void areaOfATriangleIsBaseMultipliedByHeight()
    {
        ...
        assertEquals(12, sut.getTotalArea(
                new Triangle(triangleBase, triangleHeight)), .0001);
    }
    ...
    {
        assertEquals(49.14, sut.getTotalArea(
                new Rectangle(4, 2),
                new Rectangle(3, 4),
                new Circle(1),
                new Square(1),
    ...
    {
        assertEquals(4.45, sut.getTotalArea(
                new Rectangle(1.112, 2),
                new Rectangle(1.111, 2)), .0001);
    }
