...
public class GigasecondTest {
    ...
    @Test
    public void withFullTimeSpedcifiedAndDayRollover() {
        LocalDateTime bn = null;
        LocalDateTime bn1 = LocalDateTime.now().with(LocalDateTime.MIN);
        Gigasecond gigaSecond = new Gigasecond(bn);

        assertEquals(bn1.plusSeconds(1000000000), gigaSecond.getDate());
    }
}
